...
REM Cygwin64
SET CYGWIN_HOME=C:\cygwin64\home\%USERNAME%
IF EXIST %CYGWIN_HOME%\.minttyrc del %MSYS2_HOME%\.minttyrc
mklink /H %CYGWIN_HOME%\.minttyrc %USERPROFILE%\dotfiles\mintty\.minttyrc
